...
public class StudyPage {
	...
	public void verifyBoardPaperSolution(WebDriver driver) {
		...
		if (usrgrade.getText().contains("CBSE XII-SCIENCE")) {
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 12-Science 2019 Physics Delhi(Set 1) - Solutions"),
					"Class-12 science physics set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 12-Science 2019 Physics Delhi(Set2) - Solutions"),
					"Class-12 science physics set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 12-Science 2019 Physics Delhi(Set 3) - Solutions"),
					"Class-12 science physics set 3: Board paper solution link not available");
			if (String.valueOf(BasePage.isPresentAndDisplayed(frame)) == "true") {
				WaitStatementLib.explicitWaitForVisiblity(driver, 15, frame);
				try {
					driver.switchTo().frame(frame);
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 12-Science 2019 Chemistry Delhi(Set 1) - Solutions"),
					"Class-12 science chemistry set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 12-Science 2019 Chemistry Delhi(Set 2) - Solutions"),
					"Class-12 science chemistry set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 12-Science 2019 Chemistry Delhi(Set 3) - Solutions"),
					"Class-12 science chemistry set 3: Board paper solution link not available");
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Accountancy Delhi(Set 1) - Solutions"),
					"Class-12 Commerce Accountancy set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Accountancy Delhi(Set 2) - Solutions"),
					"Class-12 Commerce Accountancy set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Accountancy Delhi(Set 3) - Solutions"),
					"Class-12 Commerce Accountancy set 3: Board paper solution link not available");
			if (String.valueOf(BasePage.isPresentAndDisplayed(frame)) == "true") {
				WaitStatementLib.explicitWaitForVisiblity(driver, 15, frame);
				try {
					driver.switchTo().frame(frame);
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Business Studies Delhi(Set 1)"),
					"Class-12 Commerce Business Studies set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Business Studies Delhi(Set 2)"),
					"Class-12 Commerce Business Studies set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 12-Commerce 2019 Business Studies Delhi(Set 3)"),
					"Class-12 Commerce Business Studies set 3: Board paper solution link not available");
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 10 2019 Science Delhi(Set 1) - Solutions"),
					"Class-10 Science set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 10 2019 Science Delhi(Set 2) - Solutions"),
					"Class-10 Science set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 10 2019 Science Delhi(Set 3) - Solutions"),
					"Class-10 Science set 3: Board paper solution link not available");
			if (String.valueOf(BasePage.isPresentAndDisplayed(frame)) == "true") {
				WaitStatementLib.explicitWaitForVisiblity(driver, 15, frame);
				try {
					driver.switchTo().frame(frame);
			...
			Assert.assertTrue(
					brdpprsolnyearrwise.get(0).getText()
							.contains("Board Paper of Class 10 2019 Hindi (A) Delhi(SET 1) - Solutions"),
					"Class-10 Hindi set 1: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(1).getText()
							.contains("Board Paper of Class 10 2019 Hindi (A) Delhi(SET 2) - Solutions"),
					"Class-10 Hindi set 2: Board paper solution link not available");
			Assert.assertTrue(
					brdpprsolnyearrwise.get(2).getText()
							.contains("Board Paper of Class 10 2019 Hindi (A) Delhi(SET 3) - Solutions"),
					"Class-10 Hindi set 3: Board paper solution link not available");
		}
	}
	...
	public void verifyPhysicsPage(WebDriver driver) {
		...
		BasePage.sleepForMilliSecond(2000);
		BasePage.isSelected(physicspart1radionbtn, "checked");
		Assert.assertTrue(BasePage.isPresentAndDisplayed(textbooksolutionsonsubjectlnk),
				"Test Book Solutions link not present");
		textbooksolutionsonsubjectlnk.click();
		BasePage.isSelected(physicspart1radionbtn, "checked");
		Assert.assertTrue(BasePage.isPresentAndDisplayed(topicstextbooksolutionson.get(0)),
				"Topics of textbook solution not present");
		BasePage.sleepForMilliSecond(2000);
		...
		Assert.assertTrue(generatetestinstruction.getText().toString().length() != 0,
				"Generate Test Instruction not present");
		for (int i = 0; i < 3; i++) {
	...
	/*
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size())).click();
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size())).sendKeys(Keys.ARROW_RIGHT);
	 * BasePage.sleepForMilliSecond(2000);
	 * topictest1stquestionoptions.get(i).click();
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size()-1)).click();
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size()-1)).sendKeys(Keys.ARROW_RIGHT);
	 * BasePage.sleepForMilliSecond(2000);
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size()-2)).click();
	 * topictest1stquestionoptions.get(topictest1stquestionoptions.size()-(
	 * topictest1stquestionoptions.size()-2)).sendKeys(Keys.ARROW_RIGHT);
	 * BasePage.sleepForMilliSecond(2000);
	 */
